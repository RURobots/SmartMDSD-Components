...
int main(int argc, char *argv[])
{
	...
	ComponentSimpleHumanBehaviourPredictor::instance()->init(argc, argv);
	// run component infrastructure until the component is commanded to shutdown
	ComponentSimpleHumanBehaviourPredictor::instance()->run();
	// clean-up component's internal resources (deleting ports, tasks, etc.)
	ComponentSimpleHumanBehaviourPredictor::instance()->fini();
	// destroy the component's singleton
	ComponentSimpleHumanBehaviourPredictor::deleteInstance();
