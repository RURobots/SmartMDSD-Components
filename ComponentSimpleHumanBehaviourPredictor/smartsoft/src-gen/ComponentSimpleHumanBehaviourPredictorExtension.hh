...
#ifndef COMPONENTSIMPLEHUMANBEHAVIOURPREDICTOR_EXTENSION_HH_
#define COMPONENTSIMPLEHUMANBEHAVIOURPREDICTOR_EXTENSION_HH_
...
public:
	ComponentSimpleHumanBehaviourPredictorExtension(const std::string &name);
	virtual ~ComponentSimpleHumanBehaviourPredictorExtension();
...
#endif /* COMPONENTSIMPLEHUMANBEHAVIOURPREDICTOR_EXTENSION_HH_ */
