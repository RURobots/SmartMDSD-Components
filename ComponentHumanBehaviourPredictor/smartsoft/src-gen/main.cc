...
int main(int argc, char *argv[])
{
	...
	ComponentHumanBehaviourPredictor::instance()->init(argc, argv);
	// run component infrastructure until the component is commanded to shutdown
	ComponentHumanBehaviourPredictor::instance()->run();
	// clean-up component's internal resources (deleting ports, tasks, etc.)
	ComponentHumanBehaviourPredictor::instance()->fini();
	// destroy the component's singleton
	ComponentHumanBehaviourPredictor::deleteInstance();
