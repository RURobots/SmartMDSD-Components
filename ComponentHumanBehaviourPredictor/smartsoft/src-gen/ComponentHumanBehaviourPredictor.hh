...
//--------------------------------------------------------------------------
#ifndef _COMPONENTHUMANBEHAVIOURPREDICTOR_HH
#define _COMPONENTHUMANBEHAVIOURPREDICTOR_HH
...
class ComponentHumanBehaviourPredictorPortFactoryInterface;
class ComponentHumanBehaviourPredictorExtension;

// includes for ComponentHumanBehaviourPredictorROSExtension

// includes for OpcUaBackendComponentGeneratorExtension

// includes for PlainOpcUaComponentHumanBehaviourPredictorExtension
...
#define COMP ComponentHumanBehaviourPredictor::instance()

class ComponentHumanBehaviourPredictor : public ComponentHumanBehaviourPredictorCore {
private:
	static ComponentHumanBehaviourPredictor *_componentHumanBehaviourPredictor;
	
	// constructor
	ComponentHumanBehaviourPredictor();
	
	// copy-constructor
	ComponentHumanBehaviourPredictor(const ComponentHumanBehaviourPredictor& cc);
	...
	std::map<std::string, ComponentHumanBehaviourPredictorPortFactoryInterface*> portFactoryRegistry;
	
	// internal map storing various extensions of this component class
	std::map<std::string, ComponentHumanBehaviourPredictorExtension*> componentExtensionRegistry;
...
public:
	...
	// define tasks
	Smart::TaskTriggerSubject* humanPredictionActivityTrigger;
	...
	// definitions of ComponentHumanBehaviourPredictorROSExtension
	
	// definitions of OpcUaBackendComponentGeneratorExtension
	
	// definitions of PlainOpcUaComponentHumanBehaviourPredictorExtension
	...
	void addPortFactory(const std::string &name, ComponentHumanBehaviourPredictorPortFactoryInterface *portFactory);
	
	SmartACE::SmartComponent* getComponentImpl();
	
	/// this method is used to register different component-extension classes
	void addExtension(ComponentHumanBehaviourPredictorExtension *extension);
	...
	static ComponentHumanBehaviourPredictor* instance()
	{
		if(_componentHumanBehaviourPredictor == 0) {
			_componentHumanBehaviourPredictor = new ComponentHumanBehaviourPredictor();
		}
		return _componentHumanBehaviourPredictor;
	}
	
	static void deleteInstance() {
		if(_componentHumanBehaviourPredictor != 0) {
			delete _componentHumanBehaviourPredictor;
		}
	}
	...
	struct connections_struct
	{
		...
		//--- task parameter ---
		struct HumanPredictionActivity_struct {
			double minActFreq;
			double maxActFreq;
			std::string trigger;
		...
		// -- parameters for ComponentHumanBehaviourPredictorROSExtension
		
		// -- parameters for OpcUaBackendComponentGeneratorExtension
		
		// -- parameters for PlainOpcUaComponentHumanBehaviourPredictorExtension
