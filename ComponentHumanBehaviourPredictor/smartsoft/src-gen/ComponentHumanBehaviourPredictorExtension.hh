...
#ifndef COMPONENTHUMANBEHAVIOURPREDICTOR_EXTENSION_HH_
#define COMPONENTHUMANBEHAVIOURPREDICTOR_EXTENSION_HH_
...
public:
	ComponentHumanBehaviourPredictorExtension(const std::string &name);
	virtual ~ComponentHumanBehaviourPredictorExtension();
...
#endif /* COMPONENTHUMANBEHAVIOURPREDICTOR_EXTENSION_HH_ */
