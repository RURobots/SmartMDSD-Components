...
#ifndef COMPONENTHUMANBEHAVIOURPREDICTOR_PORTFACTORYINTERFACE_HH_
#define COMPONENTHUMANBEHAVIOURPREDICTOR_PORTFACTORYINTERFACE_HH_
...
// forward declaration
class ComponentHumanBehaviourPredictor;

class ComponentHumanBehaviourPredictorPortFactoryInterface {
public:
	ComponentHumanBehaviourPredictorPortFactoryInterface() { };
	virtual ~ComponentHumanBehaviourPredictorPortFactoryInterface() { };

	virtual void initialize(ComponentHumanBehaviourPredictor *component, int argc, char* argv[]) = 0;
...
#endif /* COMPONENTHUMANBEHAVIOURPREDICTOR_PORTFACTORYINTERFACE_HH_ */
