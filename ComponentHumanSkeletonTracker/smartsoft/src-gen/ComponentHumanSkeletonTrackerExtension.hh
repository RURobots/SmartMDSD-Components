...
#ifndef COMPONENTHUMANSKELETONTRACKER_EXTENSION_HH_
#define COMPONENTHUMANSKELETONTRACKER_EXTENSION_HH_
...
public:
	ComponentHumanSkeletonTrackerExtension(const std::string &name);
	virtual ~ComponentHumanSkeletonTrackerExtension();
...
#endif /* COMPONENTHUMANSKELETONTRACKER_EXTENSION_HH_ */
