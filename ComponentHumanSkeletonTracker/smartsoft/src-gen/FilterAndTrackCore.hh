...
//--------------------------------------------------------------------------
#ifndef _FILTERANDTRACK_CORE_HH
#define _FILTERANDTRACK_CORE_HH
...
#include <FilterAndTrackObserverInterface.hh>


class FilterAndTrackCore
...
protected:
	...
	Smart::StatusCode humanSkeletonsPushServiceOutPut(DomainHumanTracking::CommHumanPositionsAndVelocities &humanSkeletonsPushServiceOutDataObject);
...
private:
	...
	std::list<FilterAndTrackObserverInterface*> interaction_observers;
protected:
	void notify_all_interaction_observers();
public:
	void attach_interaction_observer(FilterAndTrackObserverInterface *observer);
	void detach_interaction_observer(FilterAndTrackObserverInterface *observer);

public:
	FilterAndTrackCore(Smart::IComponent *comp, const bool &useDefaultState=true);
	virtual ~FilterAndTrackCore();
