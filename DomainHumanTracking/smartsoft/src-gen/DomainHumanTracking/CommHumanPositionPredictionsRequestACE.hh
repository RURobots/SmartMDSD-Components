...
//--------------------------------------------------------------------------
#ifndef DOMAINHUMANTRACKING_COMMHUMANPOSITIONPREDICTIONSREQUEST_ACE_H_
#define DOMAINHUMANTRACKING_COMMHUMANPOSITIONPREDICTIONSREQUEST_ACE_H_

#include "DomainHumanTracking/CommHumanPositionPredictionsRequest.hh"

#include <ace/CDR_Stream.h>

// serialization operator for DataStructure CommHumanPositionPredictionsRequest
ACE_CDR::Boolean operator<<(ACE_OutputCDR &cdr, const DomainHumanTrackingIDL::CommHumanPositionPredictionsRequest &data);

// de-serialization operator for DataStructure CommHumanPositionPredictionsRequest
...
#endif /* DOMAINHUMANTRACKING_COMMHUMANPOSITIONPREDICTIONSREQUEST_ACE_H_ */
