...
// serialization for CommHumanPositionPredictionsRequest
template <>
inline IDescription::shp_t SelfDescription(DomainHumanTracking::CommHumanPositionPredictionsRequest *obj, std::string name)
{
