...
// serialization for CommHumanPositionPredictions
template <>
inline IDescription::shp_t SelfDescription(DomainHumanTracking::CommHumanPositionPredictions *obj, std::string name)
{
