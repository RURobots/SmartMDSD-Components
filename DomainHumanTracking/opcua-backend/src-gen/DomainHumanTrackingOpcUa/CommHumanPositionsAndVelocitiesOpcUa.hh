...
// serialization for CommHumanPositionsAndVelocities
template <>
inline IDescription::shp_t SelfDescription(DomainHumanTracking::CommHumanPositionsAndVelocities *obj, std::string name)
{
